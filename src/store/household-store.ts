...
type HouseholdActions = {
  ...
  updateExpenseItem: (expenseId: string, input: Partial<ExpenseInput>) => Promise<void>;
  ...
  updateFridgeItemEntry: (itemId: string, input: Partial<FridgeItemInput>) => Promise<void>;
